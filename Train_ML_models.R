...
train_all_models <-
  function(dtrain,
    ...
    lmFit <-
      compare_models(list(lmFit, lmFit1)) # rename the best model to xxxFit
    rm(lmFit1) # remove the other Fits
    ...
    MARSFit <- compare_models(list(MARSFit, MARSFit1))
    rm(MARSFit1)
    ...
    PLSFit <- compare_models(list(PLSFit, PLSFit1))
    rm(PLSFit1)
    ...
    RidgeFit <- compare_models(list(RidgeFit, RidgeFit1))
    rm(RidgeFit1)
    ...
    LassoFit <- compare_models(list(LassoFit, LassoFit1))
    rm(LassoFit1)
    ...
    CARTFit <- compare_models(list(CARTFit, CARTFit1))
    rm(CARTFit1)
    ...
    KNNFit <- compare_models(list(KNNFit, KNNFit1))
    rm(KNNFit1)
    ...
    CubistFit <- compare_models(list(CubistFit, CubistFit1))
    rm(CubistFit1)
    ...
    SVMFit <- compare_models(list(SVMFit, SVMFit1))
    rm(SVMFit1)
    ...
    svmRadialFit <- compare_models(list(svmRadialFit, svmRadialFit1))
    rm(svmRadialFit1)
    ...
    RFFit <- compare_models(list(RFFit, RFFit1))
    rm(RFFit1)
